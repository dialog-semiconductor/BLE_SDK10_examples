...
extern volatile bool fault_escalation_flag __UNUSED;

/*
 * User-defined BusFault handler. Programmer can define their own handlers
...
void BusFault_Handler(void)
{
        ...
        (
                ...
                "ldr r2, _busfault_stack_trace                     \n" /* Branch to C fault handler implementation */
                "bx r2                                             \n"
                "_busfault_stack_trace: .word BusFault_HandlerC    \n"
        );
}
...
/*
 * User-defined BusFault handler. This is the 2nd part of the handler
 * written in C language and used for extracting the contents of the
 * stacked frame.
 *
...
__attribute__((section("text_retained")))
#endif
void BusFault_HandlerC(uint32_t *fault_args, uint32_t fp_validity_flag)
{
        uint32_t bus_fault_addr __UNUSED;

        /* Get the value of BusFault Status Register (BFSR) */
        __UNUSED uint8_t bus_fault_status_reg = _FLD2VAL(SCB_CFSR_BUSFAULTSR, SCB->CFSR);
