...
#define CHARACTERISTIC_DECLARATION(_characteristic_uuid, _characteristic_max_size, _write_prop,             \
                                        _read_prop, _notifications, _permission, _characteristic_user_descriptor,        \
        ...
        {                                                                                                   \
                  ...
                  .characteristic_att_perm             = _permission,                                       \
...
#define CHAR_ATT_PERM   att_perm_t
...
typedef struct mcs_characteristic_config {
        ...
        CHAR_ATT_PERM   characteristic_att_perm;
