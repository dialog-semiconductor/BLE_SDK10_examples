 ...
 * @file main.c
 *
 * @brief CPP cycling power profile application
 *
...
/* Task priorities */
#define mainBLE_CPP_SENSOR_TASK_PRIORITY              ( tskIDLE_PRIORITY + 1 )
...
static void system_init( void *pvParameters )
{
        ...
        OS_TASK_CREATE("CPP Sensor",                    /* The text name assigned to the task, for
                                                           debug only; not used by the kernel. */
                       cpp_sensor_task,                 /* The function that implements the task. */
                       NULL,                            /* The parameter passed to the task. */
                       2048,                            /* The number of bytes to allocate to the
                                                           stack of the task. */
                       mainBLE_CPP_SENSOR_TASK_PRIORITY,/* The priority assigned to the task. */
